...
first_message += 'На столе лежит 2021 конфета. Играют два игрока делая ход друг после друга.\n' \
                 'Первый ход определяется жеребьёвкой. За один ход можно забрать от 1 до установленного лимита конфет.\n' \
...
if mode == '1':
    ...
    print('вы ввели неверную комманду, прошу начните сначала')
    exit()
if winner == 'SUPERCOMP':
    print('Ураа! я победил! все конфеты мои! не расстраивайтесь - повезет в следующий раз.')
else:
    print(f'конец игры. победитель: {winner}. Победитель забирает все конфеты с собой!')